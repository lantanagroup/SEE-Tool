...
<sch:schema xmlns:voc="http://www.lantanagroup.com/voc" xmlns:svs="urn:ihe:iti:svs:2008" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:cda="urn:hl7-org:v3" xmlns:sdtc="urn:hl7-org:sdtc" xmlns="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.22.1.12-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.22.1.12-errors-abstract" abstract="true">
      <sch:extends rule="r-2.16.840.1.113883.10.20.22.1.1-errors-abstract" />
      <sch:assert id="a-26478" test="count(cda:templateId[@root='2.16.840.1.113883.10.20.22.1.12'])=1">SHALL contain exactly one [1..1] templateId (CONF:26478) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.22.1.12" (CONF:26479).</sch:assert>
      ...
      <sch:assert id="a-26484" test="cda:component[count(cda:structuredBody)=1]">This component SHALL contain exactly one [1..1] structuredBody (CONF:26484) such that it</sch:assert>
...
SHALL contain exactly one [1..1] effectiveTime (CONF:9030).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.22.4.4-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.22.4.4-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-9045" test="count(cda:code)=1">SHALL contain exactly one [1..1] code, which SHOULD be selected from ValueSet Problem Type 2.16.840.1.113883.3.88.12.3221.7.2 STATIC 2012-06-01 (CONF:9045).</sch:assert>
...
SHALL contain exactly one [1..1] effectiveTime (CONF:13930).</sch:assert>
      ...
      <sch:assert id="a-26448" test="cda:code">This code SHALL contain exactly one [1..1] @code, which SHOULD be selected from CodeSystem LOINC (2.16.840.1.113883.6.1) STATIC (CONF:26448).</sch:assert>
    </sch:rule>
...
SHALL contain at least one [1..*] id (CONF:8901).</sch:assert>
      ...
      <sch:assert id="a-8906" test="count(cda:performer[@typeCode='PRF'][count(cda:assignedEntity[count(cda:id) &gt; 0])=1][count(cda:templateId[@root='2.16.840.1.113883.10.20.22.4.87'])=1])=1">This performer represents the Payer.
SHALL contain exactly one [1..1] performer (CONF:8906) such that it SHALL contain exactly one [1..1] @typeCode="PRF" Performer (CodeSystem: HL7ParticipationType 2.16.840.1.113883.5.90 STATIC) (CONF:8907). SHALL contain exactly one [1..1] assignedEntity (CONF:8908). This assignedEntity SHALL contain at least one [1..*] id (CONF:8909). SHALL contain exactly one [1..1] templateId (CONF:16808). This templateId SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.22.4.87" Payer Performer (CONF:16809).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.22.4.48-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.22.4.48-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-8651" test="count(cda:code)=1">SHALL contain exactly one [1..1] code, which SHOULD be selected from ValueSet AdvanceDirectiveTypeCode 2.16.840.1.113883.1.11.20.2 STATIC 2006-10-17 (CONF:8651).</sch:assert>
...
This code SHALL contain exactly one [1..1] translation (CONF:17497).</sch:assert>
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.25.4.5-errors" context="cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.25.4.5']">
      ...
      <sch:assert id="a-17428" test="count(cda:templateId[@root='2.16.840.1.113883.10.20.25.4.5'])=1">SHALL contain exactly one [1..1] templateId (CONF:17428) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.25.4.5" (CONF:17429).</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern id="p-2.16.840.1.113883.10.20.25.4.6-errors">
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.25.4.6-errors" context="cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.25.4.6']">
      ...
      <sch:assert id="a-17456" test="count(cda:templateId[@root='2.16.840.1.113883.10.20.25.4.6'])=1">SHALL contain exactly one [1..1] templateId (CONF:17456) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.25.4.6" (CONF:17457).</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern id="p-2.16.840.1.113883.10.20.25.4.7-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.25.4.7-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-23244-c" test="not(tested)">This statusCode SHALL contain exactly one [1..1] @codeSystem (CodeSystem: ActStatus 2.16.840.1.113883.5.14) (CONF:23244).</sch:assert>
    </sch:rule>
    <sch:rule id="r-2.16.840.1.113883.10.20.25.4.7-errors" context="cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.25.4.7']">
      ...
      <sch:assert id="a-17454" test="count(cda:templateId[@root='2.16.840.1.113883.10.20.25.4.7'])=1">SHALL contain exactly one [1..1] templateId (CONF:17454) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.25.4.7" (CONF:17455).</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern id="p-2.16.840.1.113883.10.20.25.4.8-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.25.4.8-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-17448" test="cda:value[@xsi:type='CD'][@code]">This value SHALL contain exactly one [1..1] @code (CONF:17448).</sch:assert>
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.25.4.8-errors" context="cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.25.4.8']">
      ...
      <sch:assert id="a-17458" test="count(cda:templateId[@root='2.16.840.1.113883.10.20.25.4.8'])=1">SHALL contain exactly one [1..1] templateId (CONF:17458) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.25.4.8" (CONF:17459).</sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.22.4.4-warnings">
    <sch:rule id="r-2.16.840.1.113883.10.20.22.4.4-warnings-abstract" abstract="true">
      <sch:assert id="a-9045-vs" test="cda:code[@code=document('voc.xml')/voc:systems/voc:system[@valueSetOid='2.16.840.1.113883.3.88.12.3221.7.2']/voc:code/@value]">SHALL contain exactly one [1..1] code, which SHOULD be selected from ValueSet Problem Type 2.16.840.1.113883.3.88.12.3221.7.2 STATIC 2012-06-01 (CONF:9045).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.22.4.67-warnings">
    <sch:rule id="r-2.16.840.1.113883.10.20.22.4.67-warnings-abstract" abstract="true">
      <sch:extends rule="r-2.16.840.1.113883.10.20.22.4.2-warnings-abstract" />
      <sch:assert id="a-26448-vs" test="cda:code[@code and @codeSystem='2.16.840.1.113883.6.1']">This code SHALL contain exactly one [1..1] @code, which SHOULD be selected from CodeSystem LOINC (2.16.840.1.113883.6.1) STATIC (CONF:26448).</sch:assert>
...
The playingEntity, if present, SHALL contain exactly one [1..1] name (CONF:8930).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.22.4.48-warnings">
    <sch:rule id="r-2.16.840.1.113883.10.20.22.4.48-warnings-abstract" abstract="true">
      <sch:assert id="a-8651-vs" test="cda:code[@code=document('voc.xml')/voc:systems/voc:system[@valueSetOid='2.16.840.1.113883.1.11.20.2']/voc:code/@value]">SHALL contain exactly one [1..1] code, which SHOULD be selected from ValueSet AdvanceDirectiveTypeCode 2.16.840.1.113883.1.11.20.2 STATIC 2006-10-17 (CONF:8651).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.25.4.5-warnings">
    <sch:rule id="r-2.16.840.1.113883.10.20.25.4.5-warnings-abstract" abstract="true">
      <sch:assert id="a-22626-c" test="not (cda:entryRelationship) or cda:entryRelationship[@typeCode='REFR']">The entryRelationship, if present, SHALL contain exactly one [1..1] @typeCode="REFR" (CodeSystem: HL7ActRelationshipType 2.16.840.1.113883.5.1002) (CONF:22626).</sch:assert>
    </sch:rule>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.25.4.6-warnings">
    <sch:rule id="r-2.16.840.1.113883.10.20.25.4.6-warnings-abstract" abstract="true">
      <sch:extends rule="r-2.16.840.1.113883.10.20.25.4.5-warnings-abstract" />
      <sch:assert id="a-17444-c" test="not(tested)">The observation/value in Other Response Data Type Pattern SHOULD be assigned the most specific data type possible (CONF:17444).</sch:assert>
    </sch:rule>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.25.4.8-warnings">
    <sch:rule id="r-2.16.840.1.113883.10.20.25.4.8-warnings-abstract" abstract="true">
      <sch:extends rule="r-2.16.840.1.113883.10.20.25.4.5-warnings-abstract" />
      <sch:assert id="a-17450-c" test="not(tested)">If numeric score or code, observation/value/@ code SHALL be the code or score and Observation/value/translation/@code valued with the answer set OID. Translation code system is a special OID assigned to the answer list (CONF:17450).</sch:assert>
    </sch:rule>
